...
async def start(message: Message):
    ...
    response = (f"🚀 <b>Добро пожаловать в демо-версию бота!</b>\n\n"
            f"Я мониторю Telegram-каналы и ищу в них ключевые слова. <b>В этой демо-версии</b> вы увидите, как это работает:\n\n"
            f"🔹 <b>Пример ключевых слов</b>: <i>{keywords_list}</i> (у вас они будут свои)\n"
            f"🔹 <b>Пример каналов</b>: вот несколько из тех, что я сканирую (аналогично, список будет ваш)\n{chat_list}\n\n"
            f"<b>Как тестировать?</b>\n"
            f"1. Я МОМЕНТАЛЬНО присылаю вам сообщение, когда нашёл совпадения.\n"
            f"2. Кнопка «Открыть сообщение» в пересланном сообщении перенесёт вас в исходный пост.\n"
            f"3. Кнопка «Техподдержка» откроет чат, где вы сможете задать любые интересующие вас вопросы.\n\n"
            f"<b>Хотите так же, но под свои задачи?</b>\n"
            f"👉 После покупки мы <b>настроим бота индивидуально</b> под ваши ключевые слова и каналы!\n\n"
            f"<i>Попробуйте — и увидите, как это удобно!</i> 😉")
